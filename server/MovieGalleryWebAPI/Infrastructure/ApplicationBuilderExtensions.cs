    ...
    public static class ApplicationBuilderExtensions
    {
        ...
        private static void SeedMovies(MovieGalleryDbContext data)
        {
            ...
            movies.Add(new Movie
            {
                ...
                Description = "Set 30 years after its predecessor, it follows Maverick's return to the United States Navy Strike Fighter Tactics Instructor program (also known as U.S. Navy-Fighter Weapons School - \"TOPGUN\"), where he must confront his past as he trains a group of younger pilots, among them the son of Maverick's deceased best friend Lieutenant Nick \"Goose\" Bradshaw, USN.",
                Category = "Action",
                Duration = "140",
            ...
            movies.Add(new Movie
            {
                ...
                Description = "After the terrifying events in LA, John McClane (Willis) is about to go through it all again. A team of terrorists, led by Col. Stuart (Sadler) is holding the entire airport hostage. The terrorists are planning to rescue a drug lord from justice. In order to do so, they have seized control of all electrical equipment affecting all planes. With no runway lights available, all aircraft have to remain in the air, with fuel running low, McClane will need to be fast. ",
                Category = "Action",
                Duration = "124",
            ...
            movies.Add(new Movie
            {
                ...
                Description = "It is a movie about James J. Braddock. He was a boxer who became very poor during the Great Depression. But he didn't give up. He fought hard and won the Heavyweight boxing championship, making people feel hopeful. His story shows that you can overcome tough times with courage and hard work.",
                Category = "Drama",
                Duration = "145",
