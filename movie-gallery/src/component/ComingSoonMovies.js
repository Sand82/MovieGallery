   ...
   <section className="section-solid-long section-text-white position-relative">
            ...
            <div className="container position-relative">
                <div className="section-head">
                    <h2 className="section-title text-uppercase">Comming Soon</h2>
                </div>
                <div className="slick-spaced slick-carousel" data-slick-view="navigation single">
                    <div className="slick-slides">
                            ...
                            <article className="movie-line-entity">
                                ...
                                <div className="entity-content">
                                    <h4 className="entity-title">
                                        <a className="content-link" href="movie-info-sidebar-right.html">One way road</a>
                                    </h4>
                                    <div className="entity-category">
                                        <a className="content-link" href="movies-blocks.html">sport</a>,
                                        <a className="content-link" href="movies-blocks.html">musical</a>
                                    </div>
                                    <div className="entity-info">
                                        <div className="info-lines">
                                            <div className="info info-short">
                                                <span className="text-theme info-icon"><i className="fas fa-calendar-alt"></i></span>
                                                <span className="info-text">18 jul 2020</span>
                                            </div>
                                            <div className="info info-short">
                        ...
                        <div className="slick-slide">
                            <article className="movie-line-entity">
                                ...
                                <div className="entity-content">
                                    <h4 className="entity-title">
                                        <a className="content-link" href="movie-info-sidebar-right.html">Dance story</a>
                                    </h4>
                                    <div className="entity-category">
                                    ...
                                    <div className="entity-info">
                                        <div className="info-lines">
                                            <div className="info info-short">
                                                <span className="text-theme info-icon"><i className="fas fa-calendar-alt"></i></span>
                                                <span className="info-text">14 jul 2020</span>
                                            </div>
                                            <div className="info info-short">
                                                <span className="text-theme info-icon"><i className="fas fa-clock"></i></span>
                        ...
                        <div className="slick-slide">
                            <article className="movie-line-entity">
                                ...
                                <div className="entity-content">
                                    <h4 className="entity-title">
                                        <a className="content-link" href="movie-info-sidebar-right.html">Cloud 10</a>
                                    </h4>
                                    <div className="entity-category">
                                        <a className="content-link" href="movies-blocks.html">drama</a>,
                                        <a className="content-link" href="movies-blocks.html">superhero</a>
                                    </div>
                                    <div className="entity-info">
                                        <div className="info-lines">
                                            <div className="info info-short">
                                                <span className="text-theme info-icon"><i className="fas fa-calendar-alt"></i></span>
                                                <span className="info-text">19 oct 2020</span>
                                            </div>
                                            <div className="info info-short">
                                                <span className="text-theme info-icon"><i className="fas fa-clock"></i></span>
